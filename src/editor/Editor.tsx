...
export function Editor() {
  ...
  const sc = useStore((s) => s.settings.sectionOverrides);
    ...
    <div className="editor">
      ...
      <Card title="Header">
        ...
        <div className="grid-2">
          ...
          <Field label="GitHub / Portfolio" hint="without https://">
      ...
      {/* EXPERIENCE */}
      {sc.experience.enabled && (
        <Card
          title={sc.experience.label}
      ...
      {sc.projects.enabled && (
        <Card
          title={sc.projects.label}
          actions={<AddButton onClick={() => edit((r) => r.projects.push(emptyProject()))}>Add entry</AddButton>}
        >
          {resume.projects.map((p, i) => (
            <div className="entry-block" key={i}>
              ...
              {!!sc.projects.sublabel && (
                <Field label={sc.projects.sublabel}>
      ...
      {/* EDUCATION */}
      {sc.education.enabled && (
        <Card
          title={sc.education.label}
        ...
        >
          {resume.education.map((ed, i) => (
            <div className="entry-block" key={i}>
              ...
              <Field label="Detail (year, grade, campus)">
