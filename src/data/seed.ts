...
export const MASTER_RESUME: Resume = {
  ...
  skills: [
    ...
    {
      label: "Backend Frameworks & Technologies",
      value: "Node.js, NestJS, Express.js",
    },
    {
      label: "API & Architecture",
      value: "RESTful APIs, Microservices Architecture, OpenAPI/Swagger",
    },
    { label: "Databases", value: "MongoDB, PostgreSQL" },
    {
      label: "Third-Party Integrations",
      value: "Stripe, PhonePe, Razorpay, MSG91, Interakt",
    },
    {
      label: "Tools & Practices",
      value: "Git (Github), Postman, Docker, Agile/Scrum, Cursor.",
    },
    {
      label: "Concepts",
      value:
  ...
  education: [
    {
      ...
      detail:
        "2020 – 2024 | CGPA :7.99 | Moodlakatte Institute of Technology, Kundapura.",
    },
    {
...
const WELLS_FARGO_RESUME: Resume = {
  header: {
    ...HEADER,
    title: "Software Engineer | Javascript | Node.js | NestJS",
  },
  summary:
  ...
  skills: [
    ...
    },
    {
      label: "API & Architecture",
      value:
        "RESTful APIs, Microservices Architecture, OpenAPI/Swagger, Webhooks handling",
    },
    { label: "Databases", value: "MongoDB, PostgreSQL" },
    {
      label: "Third-Party Integrations",
    ...
    },
    {
      label: "Tools & Practices",
      value:
        "Git (Github), Postman, Azure Communication Services, Agile/Scrum, Cursor AI, Claude AI.",
    },
    {
      label: "Concepts",
      value:
